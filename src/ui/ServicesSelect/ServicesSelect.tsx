...
import { ServicesSelectProps } from './serviceSelect.props';

const ServicesSelect = ({ services, handleServicesChange, svgSize }: ServicesSelectProps) => {
  return (
    <div className={styles.services + ' ' + svgSize}>
      <svg
        width="800px"
        height="800px"
        className={services.includes(1) ? styles.service_checked : styles.service_unchecked}
        onClick={() => handleServicesChange(1)}
        viewBox="0 0 24 24"
        fill="none"
      ...
      <svg
        version="1.1"
        className={services.includes(2) ? styles.service_checked : styles.service_unchecked}
        onClick={() => handleServicesChange(2)}
        id="Icons"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 32 32"
      >
  ...
  s1,0.4,1,1v3h4c0.3,0,0.6-0.1,0.8-0.4c0.2-0.2,0.3-0.5,0.2-0.8L25.1,22H6.9z"
      ...
      <svg
        width="800px"
        height="800px"
        className={services.includes(3) ? styles.service_checked : styles.service_unchecked}
        onClick={() => handleServicesChange(3)}
        viewBox="0 0 24 24"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
